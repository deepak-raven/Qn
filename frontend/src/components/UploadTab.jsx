          ...
          try {
            ...
            if (payload.progress === 100) {
              setTimeout(async () => {
                ...
                await loadQuestionsForSubject(upCode, upSem, false, {
                  code: upCode,
                  name: upName,
                  semester: upSem,
                  regulation: upReg
              ...
              <div style={{ display: 'flex', gap: '0.75rem', marginTop: '0.5rem', flexWrap: 'wrap' }}>
                <button 
                  ...
                  onClick={async () => {
                    ...
                    await loadQuestionsForSubject(existingSubject.code, existingSubject.semester, false, existingSubject);
                    setActiveTab('questions');
                  }}
                >
                  Open Questions Workspace <ChevronRight size={16} />
                </button>
                <button 
                  type="button" 
                  className="btn" 
