  ...
  return (
    <div className="glass-panel card-body" style={{
      ...
      <div style={{ display: 'flex', flexDirection: 'column', gap: '0.5rem' }}>
        <div style={{ display: 'flex', justifyContent: 'space-between', alignItems: 'center', borderBottom: '1px solid var(--border-color)', paddingBottom: '0.5rem', flexWrap: 'wrap', gap: '0.5rem' }}>
          ...
          <div style={{ display: 'flex', alignItems: 'center', gap: '0.5rem' }}>
            ...
            {config && setConfig && (
              <div style={{ display: 'flex', alignItems: 'center', gap: '0.3rem' }}>
                <span style={{ fontSize: '0.72rem', fontWeight: 600, color: 'var(--text-muted)' }}>Exam:</span>
                <select
            ...
            {/* Single Auto-Generate button on left side top */}
            {handleAutoGenerateDualSets && (
              <button
                ...
                title="Automatically populate SET-I, SET-II, and SET-III with balanced questions"
              >
                <Sparkles size={13} />
