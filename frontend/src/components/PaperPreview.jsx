...
import { Trash2, GripVertical, RotateCcw, Download, Sparkles, Info, Layers, CheckCircle, X } from 'lucide-react';
  ...
  return (
    <div style={{ 
      ...
      <div style={{ display: 'flex', alignItems: 'center', justifyContent: 'space-between', borderBottom: '1px solid #d1d5db', padding: '0.25rem 0.5rem 0 0.5rem', background: '#f3f4f6', borderTopLeftRadius: '6px', borderTopRightRadius: '6px' }}>
        ...
        {/* Actions Bar */}
        <div style={{ marginLeft: 'auto', display: 'flex', alignItems: 'center', justifyContent: 'flex-end', gap: '0.5rem', paddingBottom: '0.25rem', flexWrap: 'wrap' }}>
          {handleAutoGenerateDualSets && (
            <button
              onClick={() => handleAutoGenerateDualSets()}
              className="btn"
              style={{
                display: 'flex',
                alignItems: 'center',
              ...
              title="Automatically generate SET-I and SET-II with 0% duplication & balanced Bloom's taxonomy"
            >
              <Sparkles size={13} />
              <span>⚡ Auto-Generate 2 Sets</span>
            </button>
          )}

          {generationPatternInfo && setShowPatternModal && (
            <button
              ...
              title="View blueprint pattern & 0% duplication metrics"
            >
              <Info size={13} />
              <span>Pattern Info</span>
              <span style={{ fontSize: '0.65rem', background: '#4338ca', color: '#fff', padding: '1px 5px', borderRadius: '8px' }}>
                0% Overlap
              </span>
            </button>
          )}

          {Object.keys(sets).length > 1 && handleDownloadAllSets && (
            <button
              ...
              title="Download all generated question paper sets (.docx)"
            >
              <Layers size={13} />
              <span>Download Both Sets</span>
            </button>
          )}
          ...
          {handleGeneratePaper && (
            ...
            >
              ...
              <span>Download {currentSetId}</span>
            </button>
          )}
      ...
      <div className="paper-preview">
        ...
        {/* Staff Signatures Footer Table */}
        <div style={{ marginTop: '2rem', fontFamily: "'Times New Roman', Times, serif" }}>
          <table style={{ width: '100%', borderCollapse: 'collapse', fontSize: '0.85rem', textAlign: 'center', border: '1px solid #000000' }}>
            <thead>
              <tr style={{ background: '#faf9f8' }}>
                <th style={{ border: '1px solid #000000', padding: '0.45rem', width: '25%' }}></th>
                <th style={{ border: '1px solid #000000', padding: '0.45rem', fontWeight: 'bold' }}>Name of the staff / Academic Institution / Department</th>
                <th style={{ border: '1px solid #000000', padding: '0.45rem', width: '25%', fontWeight: 'bold' }}>Sign with date</th>
              </tr>
            </thead>
            <tbody>
              <tr>
                <td style={{ border: '1px solid #000000', padding: '0.45rem', fontWeight: 'bold' }}>Prepared by</td>
                <td style={{ border: '1px solid #000000', padding: '0.45rem', textAlign: 'center', verticalAlign: 'middle', background: '#fff' }}>
                  <span
                    contentEditable
                    suppressContentEditableWarning
                    data-placeholder="Click to type name / institution / department..."
                    onBlur={(e) => setConfig(prev => ({ ...prev, prepared_by_name: e.target.innerText.trim() }))}
                    style={{
                ...
                <td style={{ border: '1px solid #000000', padding: '0.45rem', textAlign: 'center', verticalAlign: 'middle', background: '#fff' }}>
                  <span
                    contentEditable
                    suppressContentEditableWarning
                    data-placeholder="Sign with date..."
                    onBlur={(e) => setConfig(prev => ({ ...prev, prepared_by_sign: e.target.innerText.trim() }))}
                    style={{
                      display: 'inline-block',
                      width: '100%',
                      minHeight: '22px',
                  ...
                  >
                    {config.prepared_by_sign || ''}
                  </span>
                </td>
              </tr>
              <tr>
                <td style={{ border: '1px solid #000000', padding: '0.45rem', fontWeight: 'bold' }}>Verified by</td>
                <td style={{ border: '1px solid #000000', padding: '0.45rem', textAlign: 'center', verticalAlign: 'middle', background: '#fff' }}>
                  <span
                    contentEditable
                    suppressContentEditableWarning
                    data-placeholder="Click to type verifier name / department..."
                    onBlur={(e) => setConfig(prev => ({ ...prev, verified_by_name: e.target.innerText.trim() }))}
                    style={{
                      display: 'inline-block',
                      width: '100%',
                      minHeight: '22px',
                ...
                <td style={{ border: '1px solid #000000', padding: '0.45rem', textAlign: 'center', verticalAlign: 'middle', background: '#fff' }}>
                  <span
                    ...
                    suppressContentEditableWarning
                    data-placeholder="Sign with date..."
                    onBlur={(e) => setConfig(prev => ({ ...prev, verified_by_sign: e.target.innerText.trim() }))}
                    style={{
                      display: 'inline-block',
                      width: '100%',
                      minHeight: '22px',
                  ...
                  >
                    {config.verified_by_sign || ''}
                  </span>
                </td>
              </tr>
              <tr>
                <td style={{ border: '1px solid #000000', padding: '0.45rem', fontWeight: 'bold' }}>Reviewed By</td>
                <td style={{ border: '1px solid #000000', padding: '0.45rem', textAlign: 'center', verticalAlign: 'middle', background: '#fff' }}>
                  <span
                    contentEditable
                    suppressContentEditableWarning
                    data-placeholder="Click to type reviewer / HOD name / department..."
                    onBlur={(e) => setConfig(prev => ({ ...prev, reviewed_by_name: e.target.innerText.trim() }))}
                    style={{
                      display: 'inline-block',
                      width: '100%',
                      minHeight: '22px',
                ...
                <td style={{ border: '1px solid #000000', padding: '0.45rem', textAlign: 'center', verticalAlign: 'middle', background: '#fff' }}>
                  <span
                    ...
                    suppressContentEditableWarning
                    data-placeholder="Sign with date..."
                    onBlur={(e) => setConfig(prev => ({ ...prev, reviewed_by_sign: e.target.innerText.trim() }))}
                    style={{
                      display: 'inline-block',
                      width: '100%',
                      minHeight: '22px',
      ...
      {/* Pattern Explanation & Duplicate Verification Modal */}
      {showPatternModal && generationPatternInfo && (
        <div style={{
          position: 'fixed',
          top: 0,
          left: 0,
              ...
              <div style={{ display: 'flex', alignItems: 'center', gap: '0.6rem' }}>
                ...
                <div>
                  <h3 style={{ margin: 0, fontSize: '1.1rem', fontWeight: 700, color: '#ffffff' }}>
                    Auto-Generation Pattern & Verification
                  </h3>
                  <span style={{ fontSize: '0.75rem', color: '#e0e7ff', opacity: 0.9 }}>
                    Stratified Sampling & Zero-Duplication Guarantee
                  </span>
                </div>
              </div>
              <button
            ...
            <div style={{ padding: '1.5rem', maxHeight: '70vh', overflowY: 'auto' }}>
              ...
              <div style={{
                ...
                <div style={{ background: '#f8fafc', border: '1px solid #e2e8f0', borderRadius: '8px', padding: '0.75rem', textAlign: 'center' }}>
                  <span style={{ fontSize: '0.7rem', color: '#64748b', fontWeight: 600, textTransform: 'uppercase' }}>SET-I Questions</span>
                  <div style={{ fontSize: '1.25rem', fontWeight: 800, color: '#1e293b', marginTop: '2px' }}>
                    {generationPatternInfo.set1TotalCount}
                  </div>
                </div>
                <div style={{ background: '#f8fafc', border: '1px solid #e2e8f0', borderRadius: '8px', padding: '0.75rem', textAlign: 'center' }}>
                  <span style={{ fontSize: '0.7rem', color: '#64748b', fontWeight: 600, textTransform: 'uppercase' }}>SET-II Questions</span>
                  <div style={{ fontSize: '1.25rem', fontWeight: 800, color: '#1e293b', marginTop: '2px' }}>
                    {generationPatternInfo.set2TotalCount}
                  </div>
                </div>
                <div style={{ background: '#f0fdf4', border: '1px solid #bbf7d0', borderRadius: '8px', padding: '0.75rem', textAlign: 'center' }}>
                  <span style={{ fontSize: '0.7rem', color: '#166534', fontWeight: 600, textTransform: 'uppercase' }}>Cross-Set Overlap</span>
                  <div style={{ fontSize: '1.25rem', fontWeight: 800, color: '#15803d', marginTop: '2px', display: 'flex', alignItems: 'center', justifyContent: 'center', gap: '4px' }}>
                    <CheckCircle size={16} /> 0% (0 Duplicates)
                  </div>
                </div>
              </div>
              ...
              <div style={{ display: 'flex', flexDirection: 'column', gap: '0.65rem' }}>
                {generationPatternInfo.rules?.map((rule, idx) => (
                  <div key={idx} style={{
                    display: 'flex',
